...
ROOT_DB = "/Users/vanessanamirembe/Desktop/CarNet/Images"
ROOT = "/Users/vanessanamirembe/Desktop/CarNet"
ROOT_SUBSET = f"{ROOT_DB}/"
TRAIN_AND_TEST_DIR = f"{ROOT}/Images"
LOGS_FILE = f"./logs/"
CHECKPOINT_FILES = f"{ROOT_DB}/PUC"
PERCENTAGE_OF_TRAIN_IMAGES = 0.9
SAVED_MODEL = f"{ROOT}/Users/vanessanamirembe/Desktop/CarNet/SavedModel/"
EPOCHS = 500
BATCH_SIZE = 32
...
def get_average_dimensions_of_images(filename):
    ...
    with open(filename, 'r') as f:
        for line in f:
            img = Image.open("/Users/vanessanamirembe/Desktop/CarNet/Images/2012-09-11_15_16_58_jpg.rf.61d961a86c9a16694403dfcb72cd450c.jpg")
...
def convert_string_to_np_array(filename, img_height, img_width):
    ...
    with open(filename, 'r') as f:
        for line in f:
            ...
            with Image.open(ROOT_DB+"/"+image_path) as img:
...
with open(f"{SAVED_MODEL}/_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights(f"{SAVED_MODEL}/_model.h5")
